...
int CScene3::DrawGLScene(void)	// Função que desenha a cena
{
	...
	//teto
	glColor3ub(109, 54, 54);
	glVertex3f(-5.0f, 4.0f, -10.0f);
	glVertex3f(0.0f, 9.0f, -10.0f);
	...
	//To reset plano cartesiano as 0,0,0
	
	//glPushMatrix();
	// code
	//glPopMatrix();

	//no caso do boneco de neve, não aninhamos as matrizes para aplicar movimento
